...
# Carregando função de Importação da base do Economatica no formato CSV
...
## FILTRO DE LIQUIDEZ CONFORME ÍNDICE DE NEGOCIABILIDADE
# Importanto matriz com índice de Negociabilidade
